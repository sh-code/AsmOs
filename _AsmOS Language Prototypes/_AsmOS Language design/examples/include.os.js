...
main {
    include fibonacciProgram = "fibonacci.os.js"; //assign the include into a variable if we want to be able to run the whole program
    include "fibonacci.os.js"; //ignore the main program, just include the public namespaces from the file
